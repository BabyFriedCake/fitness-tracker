...
- In Personal Use mode, dataset `images/` and `videos/` may be bundled into
  local assets for offline personal-device use. Commercial Release still
  requires separate media authorization.
